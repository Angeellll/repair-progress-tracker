...
CREATE TABLE "new_Order" (
    ...
    "CateAccepted" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "EtaCompletion" DATETIME NOT NULL,
    "OrderStatus" TEXT NOT NULL,
    "OrderProgress" TEXT NOT NULL,
    "RepairmanName" TEXT NOT NULL
);
INSERT INTO "new_Order" ("ContactNo", "OrderProgress", "OrderStatus", "RefNumber", "RepairmanName", "ToolUnderRepair") SELECT "ContactNo", "OrderProgress", "OrderStatus", "RefNumber", "RepairmanName", "ToolUnderRepair" FROM "Order";
DROP TABLE "Order";
